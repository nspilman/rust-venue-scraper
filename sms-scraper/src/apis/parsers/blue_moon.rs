...
impl VenueParser for BlueMoonParser {
    fn venue_name(&self) -> &'static str {
        BLUE_MOON_VENUE_NAME
    }
    ...
    fn extract_raw_data_info(&self, raw_data: &RawEventData) -> Result<RawDataInfo> {
        ...
        Ok(RawDataInfo {
            ...
            venue_name: BLUE_MOON_VENUE_NAME.to_string(),
            event_day,
        })
    }
